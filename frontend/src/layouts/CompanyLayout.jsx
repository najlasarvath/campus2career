import { Bell, BriefcaseBusiness, Home, ListChecks, LogOut } from 'lucide-react';
import { NavLink, useNavigate } from 'react-router-dom';

const navItems = [
  { label: 'Dashboard', to: '/company', icon: Home },
  { label: 'Requirements', to: '/company/requirements', icon: ListChecks },
